...
var UtilService = (function () {
    ...
    UtilService.prototype.isDateValid = function (dateStr, dateFormat, minYear, maxYear, disableUntil, disableSince, disableWeekends, disableWeekDays, disableDays, disableDateRanges, monthLabels, enableDays) {
        var returnDate = { day: 0, month: 0, year: 0, hour: 0, minute: 0 };
        ...
        var hour = dateValue.length > 3 ? this.getNumberByValue(dateValue[3]) : 0;
        var minute = dateValue.length > 4 ? this.getNumberByValue(dateValue[4]) : 0;
        if (month !== -1 && day !== -1 && year !== -1 && hour !== -1 && hour >= 0 && hour <= 23 && minute !== -1 && minute >= 0 && minute <= 59) {
            if (year < minYear || year > maxYear || month < 1 || month > 12) {
                return returnDate;
            }
            var date = { year: year, month: month, day: day, hour: hour, minute: minute };
...
var MyDatePicker = (function () {
    function MyDatePicker(elem, renderer, cdr, localeService, utilService) {
        ...
        this.selectedDate = { year: 0, month: 0, day: 0, hour: 0, minute: 0 };
        this.minuteWithLeadingZero = "0";
        this.weekDays = [];
        this.dates = [];
        this.months = [];
        this.years = [];
        ...
        this.opts = {
            ...
            disableUntil: { year: 0, month: 0, day: 0, hour: 0, minute: 0 },
            disableSince: { year: 0, month: 0, day: 0, hour: 0, minute: 0 },
            disableDays: [],
            enableDays: [],
            markDates: [],
            markWeekends: {},
    ...
    MyDatePicker.prototype.onHourShift = function (offset) {
        this.selectedDate.hour += offset;
        if (this.selectedDate.hour > 23)
            this.selectedDate.hour = 0;
        if (this.selectedDate.hour < 0)
            this.selectedDate.hour = 23;
        this.updateDateValue(this.selectedDate);
    };
    MyDatePicker.prototype.onMinuteShift = function (offset) {
        this.selectedDate.minute += offset;
        if (this.selectedDate.minute > 59)
            this.selectedDate.minute = 0;
        if (this.selectedDate.minute < 0)
            this.selectedDate.minute = 59;
        this.updateDateValue(this.selectedDate);
    };
    ...
    MyDatePicker.prototype.onUserMinuteDisplayChange = function (event) {
        this.selectedDate.minute = parseInt(event.target.value);
        this.onUserTimeInput(String(this.selectedDate.minute), 'minute');
    };
    MyDatePicker.prototype.onUserTimeInput = function (value, unit) {
        var tmpDate = this.selectedDate;
        switch (unit) {
            case 'hour':
                tmpDate.hour = parseInt(value);
                break;
            case 'minute':
                tmpDate.minute = parseInt(value);
                break;
        }
        var dateStr = this.utilService.formatDate(tmpDate, this.opts.dateFormat, this.opts.monthLabels);
        var date = this.utilService.isDateValid(dateStr, this.opts.dateFormat, this.opts.minYear, this.opts.maxYear, this.opts.disableUntil, this.opts.disableSince, this.opts.disableWeekends, this.opts.disableWeekdays, this.opts.disableDays, this.opts.disableDateRanges, this.opts.monthLabels, this.opts.enableDays);
    ...
    MyDatePicker.prototype.selectDateTime = function (newDate, closeReason) {
        this.updateDateValue(newDate);
        if (!this.opts.withTimepicker) {
            if (this.showSelector) {
                this.calendarToggle.emit(closeReason);
    ...
    MyDatePicker.prototype.getDate = function (year, month, day, hour, minute) {
    ...
    MyDatePicker.prototype.parseSelectedDate = function (selDate) {
        var date = { day: 0, month: 0, year: 0, hour: 0, minute: 0 };
        if (typeof selDate === "string") {
            ...
            if (dateValue.length > 3)
                date.hour = this.utilService.getNumberByValue(dateValue[3]);
            if (dateValue.length > 4)
                date.minute = this.utilService.getNumberByValue(dateValue[4]);
        }
